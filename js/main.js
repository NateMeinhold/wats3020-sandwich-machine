...
let bread = prompt("what kind of bread do you want?: (white, wheat, sourdough", "white");
...
let meats = prompt("what kind of meat(s) do you want? You may select more than one by separating with a comma, for example: chicken, bacon, beef", "chicken");
...
let toppings = prompt("Enter comma separated list of toppings (such as tomato, lettuce, onions)", "lettuce, tomato, avacado");
